...
export const ITINERARY: ItineraryItem[] = [
  ...
  { id: 'd2-10b', day: 2, time: '14:30', title: '小美人魚雕像', location: 'The Little Mermaid, Langelinie, Copenhagen', notes: '安徒生童話原鄉 · 步行沿海濱散步 · 戶外 · 全天開放 · 免費', transit: { mode: 'metro', label: '地鐵 M2 → Østerport 站 · 步行約 10 分鐘' } },
  { id: 'd2-10', day: 2, time: '15:15', title: '阿馬林堡宮', location: 'Amalienborg Slotsplads, Copenhagen', notes: '丹麥皇宮廣場 · 廣場全天免費 · 博物館 10:00–16:00（15:15 抵達可入館）· 御林軍交接每日 12:00 正午', transit: { mode: 'walk', label: '步行 · 約 15 分鐘' } },
  { id: 'd2-9b', day: 2, time: '15:45', title: '新港 Nyhavn', location: 'Nyhavn, Copenhagen', notes: '彩色排屋運河街 · 拍照打卡必去 · 沿運河散步約 15 分鐘 · 戶外 · 全天開放 · 免費', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-9',  day: 2, time: '16:15', title: '國王新廣場', location: 'Kongens Nytorv, Copenhagen', notes: '哥本哈根最大廣場 · 新港運河起點 · 戶外 · 全天開放 · 免費', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-6',  day: 2, time: '16:30', title: 'Hart Bageri 丹麥麵包', location: 'Hart Bageri, Gammel Mønt 4, Copenhagen', notes: '必吃丹麥傳統麵包 · 推薦肉桂捲、可頌 · 週一至五 07:30–18:00', transit: { mode: 'walk', label: '步行 · 約 8 分鐘' }, mapsUrl: 'https://maps.app.goo.gl/HW7UgBSohHAWAGv28' },
  { id: 'd2-7',  day: 2, time: '17:30', title: 'Strøget 購物街', location: 'Strøget, Copenhagen', notes: '哥本哈根最長步行購物街，從市政廳廣場延伸至國王新廣場', transit: { mode: 'walk', label: '步行 · 約 3 分鐘' } },
  { id: 'd2-8b', day: 2, time: '18:00', title: 'DØP 丹麥熱狗 / Gasoline Grill 漢堡（晚餐可選）', location: 'Amagertorv 31 / Niels Hemmingsens Gade 20A, Copenhagen', notes: 'DØP 有機丹麥熱狗 · Amagertorv 31 · 每日 11:00–19:00｜Gasoline Grill 漢堡 · Niels Hemmingsens Gade 20A · 每日 11:00 起·售完為止', transit: { mode: 'walk', label: '步行 · 約 3 分鐘' }, mapsUrl: ['https://maps.app.goo.gl/JAtLS4Ff3iDsyVhD6', 'https://maps.app.goo.gl/vnZZREDYowVtWhhp7'] },
  { id: 'd2-7b', day: 2, time: '',      title: 'Flying Tiger Copenhagen', location: 'Flying Tiger, Strøget, Copenhagen', notes: 'Flying Tiger 發源於哥本哈根，斯楚格街上必逛 · 週一至六 10:00–19:00 · 週日 11:00–18:00', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' }, mapsUrl: 'https://maps.app.goo.gl/buuZRMasV8USmTT99' },
  { id: 'd2-7c', day: 2, time: '',      title: '安徒生雕像', location: 'Rådhuspladsen, 1553 København, Copenhagen', notes: 'H.C. 安徒生銅像 · 市政廳廣場旁 · Strøget 走到底即抵達 · 免費參觀', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },

  { id: 'd2-12', day: 2, time: '20:30', title: '返回飯店', location: 'Comfort Hotel Copenhagen Airport', notes: '', transit: { mode: 'metro', label: '步行至 Østerport 站 · 地鐵 M2 · 約 25 分鐘' } },
