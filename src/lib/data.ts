...
export const ITINERARY: ItineraryItem[] = [
  ...
  { id: 'd2-8',  day: 2, time: '15:30', title: '圓塔 Rundetårn', location: 'Rundetårn, Købmagergade 52A, Copenhagen', notes: '建於 1642 年 · 爬螺旋坡道登頂俯瞰哥本哈根市區', transit: { mode: 'walk', label: '步行 · 約 3 分鐘' } },
  { id: 'd2-8b', day: 2, time: '16:30', title: 'DØP 有機丹麥熱狗', location: 'DØP, Amagertorv 31, Copenhagen', notes: '就在 Strøget 上 · 有機食材精品熱狗 · 19:00 關門', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-9',  day: 2, time: '17:00', title: '國王新廣場', location: 'Kongens Nytorv, Copenhagen', notes: '哥本哈根最大廣場 · 新港運河起點', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-9b', day: 2, time: '17:15', title: '新港 Nyhavn', location: 'Nyhavn, Copenhagen', notes: '彩色排屋運河街 · 拍照打卡必去 · 沿運河散步約 15 分鐘', transit: { mode: 'walk', label: '步行 · 約 3 分鐘' } },
  { id: 'd2-10', day: 2, time: '18:00', title: '阿馬林堡宮', location: 'Amalienborg Slotsplads, Copenhagen', notes: '丹麥皇宮廣場 · 可能遇到御林軍交接儀式', transit: { mode: 'walk', label: '步行 · 約 10 分鐘' } },
  { id: 'd2-10b', day: 2, time: '18:30', title: '小美人魚雕像', location: 'The Little Mermaid, Langelinie, Copenhagen', notes: '安徒生童話原鄉 · 步行沿海濱散步', transit: { mode: 'walk', label: '步行 · 約 15 分鐘' } },
  { id: 'd2-11', day: 2, time: '19:30', title: '晚餐：Gasoline Grill 漢堡', location: 'Gasoline Grill, Landgreven 10, Copenhagen', notes: '世界知名精品漢堡 · 售完為止建議 19:30 前到', transit: { mode: 'walk', label: '步行 · 約 20 分鐘' } },
