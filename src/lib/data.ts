...
export const ITINERARY: ItineraryItem[] = [
  ...
  { id: 'd2-5', day: 2, time: '14:00', title: '搭地鐵 M2 前往市區', location: '哥本哈根機場地鐵站', notes: '搭 M2 往 Vanløse 方向 → Kongens Nytorv 站下車', transit: { mode: 'walk', label: '步行至地鐵站 · 約 5 分鐘' } },
  { id: 'd2-6', day: 2, time: '14:30', title: 'Hart Bageri 丹麥麵包', location: 'Hart Bageri, Gammel Mønt 8', notes: '必吃丹麥傳統麵包 · 推薦肉桂捲、可頌', transit: { mode: 'metro', label: '地鐵 M2 · 約 15 分鐘' } },
  { id: 'd2-7',  day: 2, time: '15:00', title: 'Strøget 購物街', location: 'Strøget, Copenhagen', notes: '哥本哈根最長步行購物街，從市政廳廣場延伸至國王新廣場', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-7b', day: 2, time: '',      title: 'Flying Tiger Copenhagen', location: 'Flying Tiger, Amagertorv 2, Copenhagen', notes: 'Flying Tiger 發源於哥本哈根，就在 Strøget 上，必逛', transit: { mode: 'walk', label: '步行 · 約 1 分鐘' } },
  { id: 'd2-8',  day: 2, time: '15:30', title: '圓塔 Rundetårn', location: 'Rundetårn, Købmagergade 52A, Copenhagen', notes: '建於 1642 年 · 爬螺旋坡道登頂俯瞰哥本哈根市區', transit: { mode: 'walk', label: '步行 · 約 5 分鐘' } },
  { id: 'd2-9',  day: 2, time: '16:30', title: '國王新廣場 → 新港', location: 'Nyhavn, Copenhagen', notes: '彩色排屋運河街 · 拍照打卡必去 · 沿運河散步約 15 分鐘', transit: { mode: 'walk', label: '步行 · 約 10 分鐘' } },
  { id: 'd2-10', day: 2, time: '17:30', title: '阿馬林堡宮 + 小美人魚', location: 'Amalienborg Slotsplads, Copenhagen', notes: '丹麥皇宮廣場 · 步行至小美人魚雕像約 10 分鐘', transit: { mode: 'walk', label: '步行 · 約 10 分鐘' } },
  { id: 'd2-11', day: 2, time: '19:00', title: '晚餐選項 A：DOP 丹麥熱狗', location: 'DOP, Vesterbrogade 139B, Copenhagen', notes: '丹麥精品熱狗，與 Gasoline Grill 擇一', transit: { mode: 'walk', label: '步行 · 約 15 分鐘' } },
  { id: 'd2-11b', day: 2, time: '19:00', title: '晚餐選項 B：Gasoline Grill 漢堡', location: 'Gasoline Grill, Landgreven 10, Copenhagen', notes: '精品漢堡，容易賣完建議早點去 · 與 DOP 擇一' },
  { id: 'd2-12', day: 2, time: '21:00', title: '返回飯店', location: 'Comfort Hotel Copenhagen Airport', notes: '', transit: { mode: 'metro', label: '地鐵 M2 · 約 15 分鐘' } },
